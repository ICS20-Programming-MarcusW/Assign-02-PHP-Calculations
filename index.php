   ...
   <body>
      ...
      <ul class="demo-list-three mdl-list">
         ...
         <li class="mdl-list__item mdl-list__item--three-line">
            ...
            <span class="mdl-list__item-text-body" style="color: blue">
            The Fahrenheit scale is based on a temperature scale created by physicist Daniel Gabriel Fahrenheit in 1724. The temperature is measured in degrees Fahrenheit. The fahrenheit scale is part of the imperial system. 
            </span>
            </span>
            <span class="mdl-list__item-secondary-content">
            <a class="mdl-list__item-secondary-action" href="#"><i class="material-icons">star</i></a>
      ...
      <br><br>
      <center><img src="./images/wcuts.png"></center>
      <br><br>
      <footer class="mdl-mini-footer">
         <ul class="mdl-mini-footer__link-list">
            <li><a href="#">Privacy & Terms</a></li>
            <h5><i>This webpage provides an accessible and profitable tool that will swiftly calculate the temperatures given in celsius and fahrenheit, and then converting them into the other so that you may know the temperature anywhere you are.</i></h5>
         </ul>
         </div>
      </footer>
   </body>
